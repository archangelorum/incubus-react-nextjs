...
export function StopImpersonationButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="fixed bottom-4 right-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 z-50"
    >
      {isLoading ? (
