        ...
        <div className="pt-24">
            ...
            <section className="py-12">
                <div className="container mx-auto px-4">
                    ...
                    <Suspense fallback={<div className="h-40 flex items-center justify-center">Loading genres...</div>}>
                        <GenreList />
                    </Suspense>
                </div>
            </section>
            ...
            <section className="py-12 bg-card">
                <div className="container mx-auto px-4">
                    ...
                    <Suspense fallback={<div className="h-40 flex items-center justify-center">Loading tags...</div>}>
                        <TagCloud />
                    </Suspense>
                </div>
            </section>
