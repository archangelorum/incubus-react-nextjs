                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {userRole === 'platform' && (
                        <Link href="/admin/platform/players" className="group">
                            <div className="bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-lg font-medium text-white mb-2">Platform Admin</h3>
                                <p className="text-gray-300">Manage players, staff, and platform settings</p>
                            </div>
                        </Link>
                    )}
                    ...
                    {userRole === 'publisher' && (
                        <Link href="/admin/publisher/games" className="group">
                            <div className="bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-lg font-medium text-white mb-2">Publisher Dashboard</h3>
                                <p className="text-gray-300">Manage your games and publisher staff</p>
                            </div>
                        </Link>
                    )}
                    ...
                    {userRole === 'player' && (
                        <Link href="/profile" className="group">
                            <div className="bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-lg font-medium text-white mb-2">Player Profile</h3>
                                <p className="text-gray-300">View your profile, games, and achievements</p>
                            </div>
                        </Link>
                    )}
                    ...
                    <Link href="/games" className="group">
                        <div className="bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <h3 className="text-lg font-medium text-white mb-2">Browse Games</h3>
                            <p className="text-gray-300">Explore our collection of games</p>
                        </div>
                    </Link>
